...
from core.serializers import ProfilePhotoSerializer, UserRegistrationSerializer, UserSerializer
...
class UserViewSet(ModelViewSet):
    ...
    def foto(self, request):
        ...
        # Remove a foto antiga do storage (Cloudinary/local) antes de salvar a nova
